...
## Summary
- 516 nodes · 1241 edges · 36 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: MODIFIES: 421 · contains: 262 · imports: 146 · imports_from: 122 · rationale_for: 79 · ON_BRANCH: 65 · calls: 52 · PARENT_OF: 42 · method: 29 · inherits: 14 · references: 9
...
- Excluded: 0 untracked · 32015 ignored · 1 sensitive · 1 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `183c849`
...
- `1318520 fixed some minor bugs` --PARENT_OF--> `1a6073e feat(ui): implement Mandi & Soil design system`  [EXTRACTED]
  git → git  _Bridges community 16 → community 9_
- `149a4a1 Initial commit` --PARENT_OF--> `f83feb3 Initial commit: prototype frontend.`  [EXTRACTED]
  git → git  _Bridges community 4 → community 15_
- `183c849 polish: agri-fintech design system overhaul - visual refresh + components + TS fixes` --ON_BRANCH--> `main`  [EXTRACTED]
...
Cohesion: 0.08
Nodes (10): 7435c94 feat: implement core logistics and order management dashboard with AI-driven route optimization and real-time monitoring, 9fb29c4 Merge Kisan Setu repository with backend project, b95dd39 Merge backend project into KisanSetu, eslintConfig, commonReasons, config, STATES, FAQ_ITEMS (+2 more)
...
Cohesion: 0.09
Nodes (24): 1bb7010 feat: KisanSetu v1.0 - Next-gen Agri-tech platform outperforming DeHaat & Ninjacart, full PWA, auto-deploy config, a6b87c1 feat: implement backend API foundation, payment integration, and frontend checkout service, initialLots, initialOrders, CreateOrderRequest, Listing, ListingStatus, LotListingItem (+16 more)

### Community 3 - "Community 3"
Cohesion: 0.15
Nodes (15): 4dd9e28 feat: implement initial landing page and project structure with farmer and buyer navigation flow, 6b42c2c feat: add reusable Badge, Button, and Card UI components with tailwind utility helper, CROP_BENCHMARKS, CropBenchmark, ProfitImpactSimulatorProps, Badge(), BadgeProps, Button() (+7 more)
...
Cohesion: 0.15
Nodes (13): LotDetailModalProps, CROPS, GRADES, LeafletMap, 183c849 polish: agri-fintech design system overhaul - visual refresh + components + TS fixes, 1a6073e feat(ui): implement Mandi & Soil design system, c27cac1 feat: initialize frontend application structure with buyer, farmer, and orders modules and implement primary buyer marketplace interface, dc663d4 @ feat: Complete platform audit, polish mobile navigation & fix core flows (+5 more)
...
Cohesion: 0.17
Nodes (9): AI_INSPECTION_DATA, defaultInspection, QualityInspectionModalProps, Language, LanguageContext, LanguageContextType, useLanguage(), cropEmojis (+1 more)
...
Cohesion: 0.20
Nodes (11): 55c011d Update site navigation and design enhancements, f83feb3 Initial commit: prototype frontend., CropLine, FarmerPage(), LeafletMap, makeEmptyQualityState(), PreviewType, QualityState (+3 more)
...
Cohesion: 0.18
Nodes (6): 221a7f7 feat: implement redis-based caching layer with memory fallback and introduce initial agent workflows and e2e testing framework, 9f2f3c1 feat: implement service worker for PWA support and add site navigation and authentication pages, d3a8003 feat: implement user registration module with database schema, backend auth routes, and frontend page, AuthMethod, LoginState, Role
...
- **Thin community `Community 25`** (2 nodes): `CropPhotoProps`, `MODULE_CACHE`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (2 nodes): `Role`, `Step`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `backend`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ApiService` connect `Community 17` to `Community 9`, `Community 2`, `Community 3`, `Community 15`, `Community 12`?**
