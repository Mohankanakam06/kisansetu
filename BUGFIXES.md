...
| Navigation Architecture | Private operational options visible to unauthenticated guests | Implemented clean 3-tier navigation (Guest, Farmer, Buyer). Guests see public discovery items (Market, Pricing, How It Works) and clear Sign In/Register onboarding cards, while operational tabs (Orders, Audit, Earnings) are scoped to authenticated sessions | Fixed |
