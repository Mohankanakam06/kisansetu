  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Footer */}
        <div className="p-4 sm:p-5 bg-slate-50 border-t border-slate-200 sticky bottom-0 space-y-2">
          <div className="flex items-center justify-between text-xs px-1">
            <div />
            <a
              href={`/pricing?crop=${encodeURIComponent(lot.crop_type)}&grade=${encodeURIComponent(lot.grade)}`}
