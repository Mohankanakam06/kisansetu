        ...
        if (isPicker) {
          ...
          marker.bindTooltip(
            `<div style="font-family: sans-serif; font-size: 11px; padding: 2px; text-align: center;">
              <strong>Farm Gate Pin</strong><br/>
              <span>Lat: ${selectedLocation.lat.toFixed(5)}, Lng: ${selectedLocation.lng.toFixed(5)}</span><br/>
              <span style="color: #dc2626; font-size: 10px;">Drag pin or tap map to adjust</span>
            </div>`,
