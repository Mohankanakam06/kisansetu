...
export const metadata: Metadata = {
  ...
  description: "Direct agricultural aggregation, grading, and wholesale marketplace (SIH PS 26033)",
  icons: {
    icon: "/favicon.ico",
...
const footerLinks = [
  { label: "Sell Produce", href: "/farmer" },
      ...
      <body className="min-h-dvh flex flex-col bg-[#F8FAFC] text-slate-900" suppressHydrationWarning>
        ...
        <LanguageProvider>
          ...
          <div className="fixed top-0 left-0 right-0 z-[60] bg-slate-950 text-slate-200 text-[11px] font-medium tracking-wide border-b border-slate-850 h-8 flex items-center overflow-hidden select-none">
            <Link
              href="/pricing"
              className="flex items-center gap-1.5 px-3 bg-emerald-900 hover:bg-emerald-800 text-emerald-100 font-bold shrink-0 z-10 text-[10px] uppercase tracking-wider py-1 border-r border-emerald-800/60 transition-colors"
            >
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-8 border-b border-slate-800">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-400 max-w-lg leading-relaxed">
                    Direct farm-to-buyer agricultural marketplace connecting farmers directly with wholesale buyers for transparent pricing, quick verification, and secure payments.
                  </p>
                </div>
