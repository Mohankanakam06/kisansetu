          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6 space-y-4 border-slate-200 bg-white">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                {t(
                  "Runs real-time spatial clustering on GPS coordinates within a 15km local radius. Automatically bundles 5–10 smallholder micro-listings into institutional-grade 2,000kg+ bulk lots ready for wholesale purchase.",
            ...
            <Card className="p-6 space-y-4 border-slate-200 bg-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 font-display text-base">
                    {t("4. Milestone Payment Agent", "4. चरणबद्ध भुगतान एजेंट", "4. सुरक्षित पइसा एजेंट")}
                  </h3>
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                {t(
                  "Safeguards buyer payment upon order placement. Automatically triggers a 40% initial payout directly to farmer bank accounts upon truck dispatch, and releases the final 60% immediately upon digital OTP delivery sign-off.",
