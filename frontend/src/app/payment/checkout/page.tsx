      ...
      <div className="w-full max-w-lg space-y-6">
        <div>
          ...
          <div className="flex items-center justify-between">
            <h1 className="font-display text-2xl font-black text-slate-900">{t("Secure Protected Checkout", "सुरक्षित भुगतान चेकआउट", "सुरक्षित भुगतान चेकआउट")}</h1>
          ...
          <p className="text-sm text-slate-600 mt-1">
            {t("Review lot parameters and authorize payment protection for farmer cluster.", "लॉट विवरण की समीक्षा करें और किसान क्लस्टर के लिए सुरक्षित भुगतान अधिकृत करें।", "लॉट के जांच करव आ किसान क्लस्टर बर सुरक्षित भुगतान अधिकृत करव।")}
          </p>
        </div>
        ...
        <Card className="border-slate-200 bg-white rounded-2xl p-6 shadow-card space-y-5">
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 flex justify-between items-end">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
                {t("Total Payment Protection", "कुल सुरक्षित भुगतान", "कुल सुरक्षित राशि")}
              </span>
          ...
          <div className="rounded-xl bg-emerald-50/70 border border-emerald-100 p-3.5 flex items-start gap-3 mt-4">
            ...
            <p className="text-xs text-emerald-900 font-medium leading-relaxed">
              {t(
                "100% Protected Payment. Funds remain safely held by the bank until vehicle loading verification and final quality delivery sign-off.",
                "100% सुरक्षित भुगतान। वाहन लोडिंग सत्यापन और अंतिम गुणवत्ता डिलीवरी की पुष्टि तक राशि बैंक में सुरक्षित रहती है।",
                "100% सुरक्षित पइसा। गाड़ी लोडिंग जांच अउ सही डिलीवरी होय तक पइसा बैंक म सुरक्षित रही।"
              )}
            </p>
          </div>
          ...
          >
            {loading ? (
              <>
                ...
                <span>{demoSuccess ? t("Payment Secured! Redirecting…", "भुगतान सुरक्षित! आगे बढ़ाया जा रहा है…", "पइसा सुरक्षित! आगे बढ़ावत हे…") : t("Securing Payment…", "भुगतान सुरक्षित किया जा रहा है…", "पइसा सुरक्षित करत हे…")}</span>
              </>
            ) : (
              <>
