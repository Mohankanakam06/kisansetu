...
const commonReasons = [
  ...
  { code: "INSUFFICIENT_ESCROW", label: "Protected balance low", fix: "Buyer needs to fund payment account before next payout." },
];
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="mt-4 rounded-lg border border-warning/30 bg-warning/15 p-4 text-body-sm text-amber-800">
          ...
          <ul className="mt-2 space-y-1 text-caption pl-5 list-disc">
            ...
            <li>Protected funds remain safely held in the banking settlement account.</li>
