  ...
  const TIMELINE = [
    {
      ...
      sub: t("Buyer payment secured", "खरीदार का भुगतान सुरक्षित जमा", "खरीदार के पइसा सुरक्षित जमा हो गे"),
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <Badge variant="verified">
                ...
                {t("Protected Bank Settlements", "सुरक्षित बैंक भुगतान", "सुरक्षित बैंक पइसा")}
              </Badge>
            </div>
            <h1 className="font-display text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
              {t("Farmer Earnings & Payment Ledger", "किसान कमाई एवं भुगतान लेजर", "किसान कमाई आ पइसा बहीखाता")}
            </h1>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8">
            ...
            <div>
              <div className="flex items-center justify-between">
                <p className="text-[10px] font-bold uppercase tracking-wider text-amber-900">
                  {t("Protected in Transit (Pending Release)", "रास्ते में सुरक्षित (आगामी भुगतान)", "रस्ता म सुरक्षित (आने वाला पइसा)")}
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          <Card className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <h2 className="font-display text-base font-extrabold text-slate-900 flex items-center gap-2">
                <Banknote className="h-5 w-5 text-emerald-800" /> {t("Payment Protection Timeline", "भुगतान सुरक्षा समयरेखा", "भुगतान सुरक्षा पड़ाव")}
              </h2>
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            {/* 2-Stage Payment Ledger Breakdown */}
            {orders.length > 0 && (
              <Card className="space-y-4">
                <div className="border-b border-slate-100 pb-3">
                  <h2 className="font-display text-sm font-extrabold text-slate-900 flex items-center gap-2">
                    <ShieldCheck className="h-4 w-4 text-emerald-800" /> {t("Active Payment Protection Split (40/60)", "सक्रिय सुरक्षित भुगतान विभाजन (40/60)", "चालू पइसा बंटवारा (40/60)")}
                  </h2>
                      ...
                      <tr>
                        <td colSpan={5} className="px-4 py-8 text-center text-slate-500 text-xs font-medium">
                          <div className="flex justify-center items-center gap-2">
                            <span className="h-4 w-4 animate-spin rounded-full border-2 border-emerald-200 border-t-emerald-700 block" />
                            {t("Loading ledger...", "लेजर लोड हो रहा है...", "लेजर लोड होवत हे...")}
                          </div>
                        </td>
                      </tr>
                    ) : orders.length === 0 ? (
